...
*Difficulty: Easy*
[Solution](src/Recyclable_and_Low_Fat_Products.sql)

### Find Customer Referee
*Difficulty: Easy*
[Solution](src/Find_Customer_Referee.sql)

### Big Countries
*Difficulty: Easy*
[Solution](src/Big_Countries.sql)

### Article Views I
*Difficulty: Easy*
[Solution](src/Article_Views_I.sql)

### Invalid Tweets
*Difficulty: Easy*
[Solution](src/Invalid_Tweets.sql)

## Basic Joins

### Replace Employee ID With The Unique Identifier
*Difficulty: Easy*
[Solution](src/Replace_Employee_ID_With_The_Unique_Identifier.sql)

### Product Sales Analysis I
*Difficulty: Easy*
[Solution](src/Product_Sales_Analysis_I.sql)

### Customer Who Visited but Did Not Make Any Transactions
*Difficulty: Easy*
[Solution](src/Customer_Who_Visited_but_Did_Not_Make_Any_Transactions.sql)

### Rising Temperature
*Difficulty: Easy*
[Solution](src/Rising_Temperature.sql)

### Average Time of Process per Machine
*Difficulty: Easy*
[Solution](src/Average_Time_of_Process_per_Machine.sql)

### Employee Bonus
*Difficulty: Easy*
[Solution](src/Employee_Bonus.sql)

### Students and Examinations
*Difficulty: Easy*
[Solution](src/Students_and_Examinations.sql)

### Managers with at Least 5 Direct Reports
*Difficulty: Medium*
[Solution](src/Managers_with_at_Least_5_Direct_Reports.sql)

### Confirmation Rate
*Difficulty: Medium*
[Solution](src/Confirmation_Rate.sql)

## Basic Aggregate Functions

### Not Boring Movies
*Difficulty: Easy*
[Solution](src/Not_Boring_Movies.sql)

### Average Selling Price
*Difficulty: Easy*
[Solution](src/Average_Selling_Price.sql)

### Project Employees I
*Difficulty: Easy*
[Solution](src/Project_Employees_I.sql)

### Percentage of Users Attended a Contest
*Difficulty: Easy*
[Solution](src/Percentage_of_Users_Attended_a_Contest.sql)

### Queries Quality and Percentage
*Difficulty: Easy*
[Solution](src/Queries_Quality_and_Percentage.sql)

### Monthly Transactions I
*Difficulty: Medium*
[Solution](src/Monthly_Transactions_I.sql)

### Immediate Food Delivery II
*Difficulty: Medium*
[Solution](src/Immediate_Food_Delivery_II.sql)

### Game Play Analysis IV
*Difficulty: Medium*
[Solution](src/Game_Play_Analysis_IV.sql)

## Sorting and Grouping

### Number of Unique Subjects Taught by Each Teacher
*Difficulty: Easy*
[Solution](src/Number_of_Unique_Subjects_Taught_by_Each_Teacher.sql)

### User Activity for the Past 30 Days I
*Difficulty: Easy*
[Solution](src/User_Activity_for_the_Past_30_Days_I.sql)

### Product Sales Analysis III
*Difficulty: Medium*
[Solution](src/Product_Sales_Analysis_III.sql)

### Classes More Than 5 Students
*Difficulty: Easy*
[Solution](src/Classes_More_Than_5_Students.sql)

### Find Followers Count
*Difficulty: Easy*
[Solution](src/Find_Followers_Count.sql)

### Biggest Single Number
*Difficulty: Easy*
[Solution](src/Biggest_Single_Number.sql)
